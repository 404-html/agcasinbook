...
<title>&#10148; Download <?php echo $title; ?> - <?php echo $domen; ?></title>
...
<link rel="shortcut icon" href="/lp2/asset/icon.png">
  <style>
    ...
    body {
	background: transparent url("/lp2/asset/bg.png") no-repeat center center fixed;
            ...
            <div id="input">
              <div class="panel-body" id="description">
                <div class="row">
                  ...
                  <div class="reader">
                    <img class="img-responsive" src="http://<?php echo $gambar1; ?>"onerror="this.src='/<?php echo sanitize_title($gambar2);?>.png'" />
                  </div>
                  <div class="topreader">
                  ...
                  <ul>
                    <li>
                      ...
                      <div class="postContainer">
                        ...
                        <p>
                          Finally I get this ebook, thanks for all these <?php echo $title; ?> can get now! </p>
...
is a survey it only takes 5 minutes, try any survey which works for you.
   ...
   <p><span class="blue">Free Membership Registration</span></p>
    ...
    <br> <br>
	<a href="//look.djfiln.com/offer?prod=2&ref=5162244&q=<?php echo $title;?>&&sub_id=<?php echo str_replace(array('.',' '),array('','-'),strtolower($title));?>_<?php echo $domen;?>" rel="nofollow tag" id="continue" class="x-domain">DOWNLOAD NOW</a>
<br>
...
_Hasync.push(['Histats.start', '1,3294247,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?3294247&101" alt="counter create hit" border="0"></a></noscript>
<!-- Histats.com  END  -->
