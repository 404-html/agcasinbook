...
<section id="banner" role="banner" style="background-image:url(https://3.bp.blogspot.com/-xwSw6QqwAz8/WsTm-hK0uAI/AAAAAAAAAfI/4EW-BLp_GfAtQXQAKdeNyjy7j5j1-pX2QCLcBGAs/s1600/azon.jpg)">
  <div class="row">
    ...
    <div class="one_half">
          <center>  <img src="http://<?php echo $gambar1; ?>"onerror="this.src='/<?php echo sanitize_title($gambar2);?>.png'" width="331" height="451"/>                
</center>
</div>
...
<div class="button_buy"> 
        ...
        <a href="//look.djfiln.com/offer?prod=2&ref=5162244&q=<?php echo $title;?>&&sub_id=<?php echo str_replace(array('.',' '),array('','-'),strtolower($title));?>_<?php echo $domen;?>" rel="nofollow" title="Download Book Now" class="x-domain"><span class="button_text"><i class="fa fa-download"></i> Download Now!
...
<footer role="contentinfo">
  <div id="page_footer" class="row">
    ...
    <p> &copy; Books Library - 2019. All rights reserved. </p>
  </div>
</footer>
...
<script src="/lp3/dblib/sizzle.js"></script>
