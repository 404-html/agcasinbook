...
<html>
	...
	<p>Upon receipt of Notice as described below, our Designated Copyright Agent will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged use from the Service and/or termination of the user's account in appropriate circumstances.</p>
	...
	<li>I hereby state under penalty of perjury that I have a good faith belief that the material was removed or disabled as a result of mistake or miss-identification of the material to be removed or disabled.</li>
	...
	c/o <?php echo $domen; ?><br />
	a/n Nn Johntor</p>
	<h3>Notification of Trademark Infringement</h3>
	<p>If you believe that your trademark (the 'Mark') is being used by a user in a way that constitutes trademark infringement, please provide our Designated Copyright Agent (specified above) with the following information:</p>
	<ol>
	...
	<li>Identification of the Mark(s) alleged to have been infringed, including (i) for registered Marks, a copy of each relevant federal trademark registration certificate or (ii) for common law or other Marks, evidence sufficient to establish your claimed rights in the Mark, including the nature of your use of the Mark, and the time period and geographic area in which the Mark has been used by you;</li>
	...
	<p>A registered user may respond to notice of take-down by showing either (a) that the claimant does not own the IP or (b) that the IP is not infringed. If the registered user succeeds in showing either (a), (b) or (c) then our Designated Copyright Agent may exercise its discretion not to remove the IP.</p>
	<p>If our Designated Copyright Agent decides to comply with a take-down request, it will do so within a reasonably expeditious period of time.</p>
	<h3>We Have No Obligation to Adjudicate IP Claims 'User's Agreement to Hold Us Harmless From Claims</h3>
	<p>Claimants and users must understand that we are not an intellectual property tribunal. While we and our Designated Copyright Agent may in our discretion use the information provided in order to decide how to respond to infringement claims, we are not responsible for determining the merits of such claims.</p>
	<p>If a user responds to a claim of infringement by providing assurances that its content is not infringing, the user agrees that if we thereafter restore or maintain the content, the user will defend and hold us harmless from any resulting claims of infringement brought against us and our Designated Copyright Agent.</p>
	<h3>Violations and Comments</h3>
	<p>Violations and Comments</p>
	<p>Please report any violations of the TOS to <a href="http://<?php echo $domen; ?>/contact" rel="nofollow">http://<?php echo $domen; ?>/contact</a></p>
    </body>
</html>